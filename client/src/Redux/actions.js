...
export const postRecipes = ({title, summary, image, healthScore, analyzedInstructions, diets}) =>{
    return async function (dispatch){
        try {
            const api = await axios.post('http://localhost:3001/recipes',{title, summary, image, healthScore, analyzedInstructions, diets})
